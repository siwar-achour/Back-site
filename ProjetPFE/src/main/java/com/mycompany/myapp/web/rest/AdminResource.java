...
public class AdminResource {
    ...
    public ResponseEntity<Admin> updateAdmin(@PathVariable(value = "id", required = false) final String id, @RequestBody Admin admin)
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, admin.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<Admin> partialUpdateAdmin(
        ...
        return ResponseUtil.wrapOrNotFound(result, HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, admin.getId()));
    }
